import { ev, isZeroVec, normalize, randomInCircle, scaleVec, subVec, type Vec2, vec2, vecLengthSquared } from "../../../games/caveGame/common";
import type { BoxCollider } from "../collider/colliders";
import { type GameObject, type ItemId, KNIFE_OFFSET_Y, type Player as NetPlayer } from "../../../games/caveGame/common/game";
import { defaultInputs, type Inputs } from "../../../games/caveGame/common/input";
...
export class Player implements GameObject {
	...
	inventory = new Map<ItemId, number>([
		["knife", 1],
		["meatball", 67],
		["seed", 1],
	]);
